...
class StoreCategoryCategoryGridViewAdapter(private var context: Context, val items: List<temp>): BaseAdapter() {
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        val view : View = inflater.inflate(R.layout.gridview_item_storecategory_category, p2, false)

        val img = view.findViewById<ImageView>(R.id.gridview_storecategory_category_img)
        val name = view.findViewById<TextView>(R.id.gridview_storecategory_category_name)
